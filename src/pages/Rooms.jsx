...
function SpaceDiv() {
  return <div className="sec_space"></div>;
}
      ...
      <div className="sec_additional_filters">
        ...
        <p>
          <input
            ...
            value="unreserved"
          />
          <label htmlFor="unreserved">
            Only show the rooms that are not yet booked
          </label>
        </p>
        <p>
          <input type="checkbox" id="toilet" name="toilet" value="toilet" />
          <label htmlFor="toilet">Must have an attached toilet</label>
        </p>
        <p>
          <input type="checkbox" checked id="fan" name="fan" value="fan" />
          <label htmlFor="fan">Must have a fan</label>
        </p>
        <br></br>
        ...
        <div className="toilet_type_g">
          <p>
            <input
              ...
              value="rb_all"
            />
            <label htmlFor="rb_all">Any</label>
          </p>
          <p>
            <input
              type="radio"
              ...
              value="rb_indian"
            />
            <label htmlFor="rb_indian">Indian Toilet</label>
          </p>
          <p>
            <input
              type="radio"
              ...
              value="rb_western"
            />
            <label htmlFor="rb_western">Western Toilet</label>
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="room_text">
        ...
        <div className="room_description">
          <p className="rd_main">
            ...
            deserunt esse impedit inventore
          </p>
        </div>
    ...
    <div className={"sec_result_area " + expandSection}>
      ...
      <div className="sec_pagination">
        <p className="h5">
          ...
          <span id="sp_page_total">{"totalPg"}&nbsp;</span>({" "}
          <span id="sp_page_resultcount">{"totalResults"}&nbsp;</span> results)
        </p>
        <p>
  ...
  return (
    <div className="sec_rooms">
      <div className="sec_mobile_button">
        <button
          className="bt bt_pill bg_green_d_t_white"
